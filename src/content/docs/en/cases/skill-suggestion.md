...
| :--- | :--- | :--- |
| `C1` | Call 1 - skim all 182 skills | Call 1 - skim all 182 skills |
| `Q1` | Choice: which skill fits? / all 182, one line each | Call 1 - skim all 182 skills |
| `N1` | Nouls: need a skill at all? / · act on their stuff? / · follow written steps? / · or just talk? | Call 1 - skim all 182 skills |
| `C2` | Call 2 - read those 3 properly | Call 2 - read those 3 properly |
| `Q2` | Choice: which of the 3? / with real detail now | Call 2 - read those 3 properly |
| `N2` | Nouls: does each one / really do it? | Call 2 - read those 3 properly |
...
* **`which`** is a [`Choice`](/en/primitives/choice/) question
...
* **three [`Noul`](/en/primitives/noul/) questions about the
