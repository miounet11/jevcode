...
TypeSafe エージェントスキルは、AI コーディングエージェントに対して、TypeSafe API の完全なコンテキストを提供します。これには、3 種類の[問題タイプ](/ja/primitives/)、アーキテクチャの[パターン](/ja/patterns/)、および組織的な評価のベストプラクティスが含まれます。
...
- [SDK 概要](/ja/sdk/) — Python および JS SDK
- [問題プリミティブ](/ja/primitives/) — エージェントが理解すべき 3 つの問題
- [信頼度](/ja/concepts/confidence/) — 閾値の設定方法
