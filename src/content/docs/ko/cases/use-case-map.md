...
> **카테고리별 정리된 전체 프로젝트 인덱스**(별 수 및 언어 태그 포함)를 보려면 [커뮤니티 생태계 프로젝트](/zh/ecosystem/)를 참조하세요.
...
**원리**: Score, [복합 점수 매기기](/zh/patterns/composite-scoring/)를 사용하여 다차원을 병합.
...
- [아키텍처 패턴](/zh/patterns/) — 이러한 사례 뒤에 있는 일반적인 패턴
- [문제 원리](/zh/primitives/) — 원리 선택 방법
