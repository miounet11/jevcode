...
- **[Choice](/zh/primitives/choice/)** — 상호 배타적인 후보 그룹 중 하나를 선택합니다. 의도 인식, 티켓 라우팅, 작업 선택에 사용됩니다.
- **[Score](/zh/primitives/score/)** — 척도나 평가 기준에 따라 점수를 매깁니다. 관련성 정렬, 품질 평가, 위험 등급 분류에 사용됩니다.
- **[Noul](/zh/primitives/noul/)** — 예/아니오 질문에 답변하며, '예'일 확률을 반환합니다. 콘텐츠 검증, 어설션 확인, 가드레일에 사용됩니다.
...
- [5분 시작하기](/zh/quickstart/) — API 키를 받고 첫 호출을 실행합니다.
- [핵심 개념](/zh/concepts/system-one/) — System One과 상태 모델 이해
- [아키텍처 패턴](/zh/patterns/) — 프로덕션 환경에서 이러한 호출을 조직하는 방법 보기
