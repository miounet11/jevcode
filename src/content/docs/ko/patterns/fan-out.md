...
**신뢰도(confidence)와 함께 사용하세요.** 팬아웃은 「무엇을 물을 것인가」를 해결하고, 신뢰도 라우팅은 「얼마나 믿을 것인가」를 해결합니다. 이 둘을 조합한 형태는 프로덕션 시스템에서 흔히 볼 수 있습니다: [신뢰도 라우팅](/zh/patterns/confidence-routing/)의 음성 뱅크 예시를 참조하세요.

## 관련

- [질문 원시 타입](/zh/primitives/) — 독립성과 추측성 질문
- [State](/zh/concepts/state/) — 컨텍스트 예산 및 state 조직화
- [신뢰도 라우팅](/zh/patterns/confidence-routing/) — 두 번째 의사결정 축
