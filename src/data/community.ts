/**
 * 社区脉搏数据（community pulse）。
 *
 * 条目来源：运维提供的推文 bundle（.research/qmuse/），
 * 经 scripts/community-prepare.mjs 门控（Jev 批级相关性 + 传播量/项目链接资格）。
 * 展示原则（Jev 轮 11 判定 gated_with_attribution 0.99）：
 *   - 每条注明原作者与原推链接，一行为英文原文摘录（非全文）
 *   - 不复制第三方集合的机翻；中文读者看英文原文 + 我们自己的分类体系
 *   - 法律风险自评 Low 0.80（创意复刻、表达原创）
 */
...
export function categorize(text: string): string {
  for (const c of pulseCategories) {
    if (c.match.test(text)) return c.key;
  }
  return 'other';
}
export const pulseEntries: PulseEntry[] = [
  ...
  {
    id: "2101009970045071824",
    author: "Cloudflare",
    screenName: "Cloudflare",
  ...
  {
    id: "2101006253829046539",
    author: "Eugene Cheah - AI builder @ 🇸🇬|🇺🇸",
    screenName: "picocreator",
  ...
  {
    id: "2100980770206879849",
    author: "Sarvagya Kulshreshtha",
    screenName: "sarvagya_kul",
  ...
  {
    id: "2100979515388473828",
    author: "Sydney Runkle",
    screenName: "sydneyrunkle",
  ...
  {
    id: "2100970015977804008",
    author: "ego",
    screenName: "ego_agent",
  ...
  {
    id: "2100966838905585687",
    author: "Oskar",
    screenName: "o_kwasniewski",
  ...
  {
    id: "2100959576682012988",
    author: "Rafal Wilinski",
    screenName: "rafalwilinski",
  ...
  {
    id: "2100953553917313180",
    author: "Remek Kinas",
    screenName: "KinasRemek",
  ...
  {
    id: "2100951738606035176",
    author: "Raihan Khan",
    screenName: "raihankhan_rk",
  ...
  {
    id: "2100951550248309179",
    author: "marcus",
    screenName: "marcusyul",
  ...
  {
    id: "2100939189869002819",
    author: "Stav Zilbershtein",
    screenName: "mightyking",
  ...
  {
    id: "2100929105382564113",
    author: "Indra",
    screenName: "IndraVahan",
  ...
  {
    id: "2100906882365788167",
    author: "Marcel Pociot 🧪",
    screenName: "marcelpociot",
  ...
  {
    id: "2100891604735099103",
    author: "Romàn",
    screenName: "romanbuildsaas",
  ...
  {
    id: "2100883711260823912",
    author: "阿蔺A-Lin",
    screenName: "alin_zone",
  ...
  {
    id: "2100852540900520097",
    author: "Ashutosh Mathore",
    screenName: "ashutoshftw",
  ...
  {
    id: "2100833655518367871",
    author: "Lomesh Dutta",
    screenName: "lomeshdutta",
  ...
  {
    id: "2100814590300889426",
    author: "Andy Gao",
    screenName: "instantricecook",
  ...
  {
    id: "2100757989212754085",
    author: "Alan Daitch",
    screenName: "AlanDaitch",
  ...
  {
    id: "2100749640866165092",
    author: "Rinte",
    screenName: "rinte0321",
  ...
  {
    id: "2100745778390081563",
    author: "Wuyang Zhou",
    screenName: "wuyang_zhou",
  ...
  {
    id: "2100744709589316009",
    author: "OpenRouter",
    screenName: "OpenRouter",
  ...
  {
    id: "2100736122502390211",
    author: "Jon Taylor",
    screenName: "JonPTaylor",
  ...
  {
    id: "2100735977262141735",
    author: "Michael",
    screenName: "michaeltefula",
  ...
  {
    id: "2100734646824902713",
    author: "かねこつよし",
    screenName: "tsuyoshi_osiire",
  ...
  {
    id: "2100720719470494126",
    author: "Zain Hoda",
    screenName: "zain_hoda",
  ...
  {
    id: "2100717739556167722",
    author: "Ansh Nanda",
    screenName: "anshnanda",
  ...
  {
    id: "2100715237267660873",
    author: "Moritz Kremb",
    screenName: "moritzkremb",
  ...
  {
    id: "2100706874173575199",
    author: "Max Rovensky",
    screenName: "MaxRovensky",
  ...
  {
    id: "2100706455523561909",
    author: "TypeSafe AI",
    screenName: "typesafeai",
  ...
  {
    id: "2100700176444731780",
    author: "Zachi",
    screenName: "iam_zachi",
  ...
  {
    id: "2100690568947159309",
    author: "Utkarsh Agrawal",
    screenName: "uttkarsh_42",
  ...
  {
    id: "2100675952317792734",
    author: "Zade",
    screenName: "zadescoxp",
  ...
  {
    id: "2100674306405814568",
    author: "Yohei",
    screenName: "yoheinakajima",
  ...
  {
    id: "2100670497818313175",
    author: "Nick Vasilescu",
    screenName: "nickvasiles",
  ...
  {
    id: "2100654891756589230",
    author: "Matthew Berman",
    screenName: "TheMattBerman",
  ...
  {
    id: "2100648648434434298",
    author: "camsoft2000",
    screenName: "camsoft2000",
  ...
  {
    id: "2100646513412292873",
    author: "Haoran | 公众号：独立开发",
    screenName: "hr98w",
  ...
  {
    id: "2100646448324833512",
    author: "Konrad Reczko",
    screenName: "reczko_konrad",
  ...
  {
    id: "2100644221279424925",
    author: "atomic.chat",
    screenName: "atomic_chat_hq",
  ...
  {
    id: "2100631847155994852",
    author: "Milind S",
    screenName: "milindlabs",
  ...
  {
    id: "2100631665336836308",
    author: "Öner S. Biberkökü",
    screenName: "OnerBiberkoku",
  ...
  {
    id: "2100628223780397541",
    author: "Harshil",
    screenName: "harshil1712",
  ...
  {
    id: "2100617830890885415",
    author: "Nidhi Singh",
    screenName: "nidhisinghattri",
  ...
  {
    id: "2100615772053877164",
    author: "Yoshiki Miura",
    screenName: "miiura",
  ...
  {
    id: "2100611346203353110",
    author: "Chris Nicholas",
    screenName: "ctnicholasdev",
  ...
  {
    id: "2100606378184171682",
    author: "Rory Garton-Smith",
    screenName: "rory_builds",
  ...
  {
    id: "2100592786516951490",
    author: "Niels Rogge",
    screenName: "NielsRogge",
  ...
  {
    id: "2100590065357639971",
    author: "あきらパパ【生成AI活用エンジニア&３児のパパ】",
    screenName: "akira_papa_IT",
  ...
  {
    id: "2100570643355852954",
    author: "Theo Otz",
    screenName: "Totzenberger",
  ...
  {
    id: "2100544998391349310",
    author: "Norbert Bodziony 🇵🇱",
    screenName: "norbertbodziony",
  ...
  {
    id: "2100524915007144289",
    author: "Duncan",
    screenName: "ephraimduncan",
  ...
  {
    id: "2100487878992388279",
    author: "Wayne Sutton",
    screenName: "waynesutton",
  ...
  {
    id: "2100474943154827344",
    author: "石川陽太 Yota Ishikawa",
    screenName: "ytiskw",
  ...
  {
    id: "2100473581251748216",
    author: "Chetaslua",
    screenName: "chetaslua",
  ...
  {
    id: "2100467548298899918",
    author: "Shannon 🤖☠️",
    screenName: "iamMrDuncan",
  ...
  {
    id: "2100465662867218857",
    author: "Niaz Morshed",
    screenName: "niazmorshed_",
  ...
  {
    id: "2100457614073327754",
    author: "Cris Lenta",
    screenName: "crislenta",
  ...
  {
    id: "2100448995415863323",
    author: "Vlad Terin",
    screenName: "VladTerin",
  ...
  {
    id: "2100438907611660510",
    author: "Aditya A.",
    screenName: "iamAdityaAnjana",
  ...
  {
    id: "2100410071192682885",
    author: "Pontus Karlsson",
    screenName: "coolastekatten",
  ...
  {
    id: "2100408498446111031",
    author: "Mormon Negro",
    screenName: "mormonnegro",
  ...
  {
    id: "2100408276949385668",
    author: "Isaac Tai 🧇",
    screenName: "hi_im_isaac_",
  ...
  {
    id: "2100399951872205224",
    author: "Shane",
    screenName: "digitalshane_",
  ...
  {
    id: "2100356151468585346",
    author: "Jarrod Watts",
    screenName: "jarrodwatts",
  ...
  {
    id: "2100347770867458384",
    author: "Justin Schroeder",
    screenName: "jpschroeder",
  ...
  {
    id: "2100335978229690683",
    author: "Roman Slack",
    screenName: "RomanSlack1",
  ...
  {
    id: "2100325221932958134",
    author: "Toran Bruce Richards",
    screenName: "SigGravitas",
  ...
  {
    id: "2100322626204004793",
    author: "Raghav",
    screenName: "RaghavPunnam",
  ...
  {
    id: "2100315518930661861",
    author: "Marcus Lowe",
    screenName: "marcus_lowe",
  ...
  {
    id: "2100313645116952701",
    author: "joogie",
    screenName: "princecaarlo",
  ...
  {
    id: "2100281474943779254",
    author: "it’s rivian",
    screenName: "rrriviannn",
  ...
  {
    id: "2100243609060856264",
    author: "Theodore",
    screenName: "theoleecj",
  ...
  {
    id: "2100218045549412499",
    author: "vogel",
    screenName: "ryanvogel",
  ...
  {
    id: "2100190746389135772",
    author: "Matija Sosic",
    screenName: "MatijaSosic",
  ...
  {
    id: "2100098315144602056",
    author: "cocktail peanut",
    screenName: "cocktailpeanut",
  ...
  {
    id: "2100086301894881578",
    author: "Faadil Shaik",
    screenName: "faadilhshaik",
  ...
  {
    id: "2100081351508767003",
    author: "Just_Lingonberry_352 🌼",
    screenName: "JustLingonberry",
  ...
  {
    id: "2100012553065644103",
    author: "Yuntian Deng",
    screenName: "yuntiandeng",
  ...
  {
    id: "2099946321495068746",
    author: "Rohan Paul",
    screenName: "rohanpaul_ai",
  ...
  {
    id: "2099925682726002904",
    author: "Diogo Almeida",
    screenName: "CompleteSkeptic",
